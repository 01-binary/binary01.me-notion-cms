...
import { GracefulImage } from '@/features/posts/notion-components/graceful-image';
import { PageTitle } from '@/features/posts/notion-components/page-title';
import { formatDate, getHashFragmentValue } from '@/features/posts/notion-components/utils';
import { Decoration } from '@/interfaces/notion';
import { Block, ExternalObjectInstance } from '@/interfaces/notion-block';

import { parsePageId } from '@/utils/getPage';
          ...
          switch (decorator[0]) {
                ...
                case 'u': {
                  ...
                  return (
                    <GracefulImage
                      ...
                      src={mapImageUrl(user.profile_photo, block) as string}
                      alt={name}
                    />
                  );
                }
            ...
            case 'a': {
              ...
              if ((v[0] === '/' || v.includes(rootDomain as string)) && id) {
                const href = v.includes(rootDomain as string)
                  ? v
            ...
            case 'd': {
              ...
              if (type === 'date') {
                ...
                const startDate = v.start_date;
                const endDate = v.end_date as string;
