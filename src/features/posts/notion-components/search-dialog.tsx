...
import { LoadingIcon } from '@/features/posts/icons/loading-icon';
import { SearchParams, SearchResults } from '@/features/posts/notion-components/header';
import { cs, getBlockParentPage, getBlockTitle } from '@/features/posts/notion-components/utils';
...
export class SearchDialog extends React.Component<{
  ...
  state = {
    isLoading: false,
    query: '',
    searchResult: null as SearchResults | null,
    searchError: null,
  };
  ...
  _searchImpl = async () => {
    ...
    let searchError: APIError | null = null;
