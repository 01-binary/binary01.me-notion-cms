...
import { LinkIcon } from '@/features/posts/icons/link-icon';
import { AssetWrapper } from '@/features/posts/notion-components/asset-wrapper';
import { Audio } from '@/features/posts/notion-components/audio';
import { EOI } from '@/features/posts/notion-components/eoi';
import { File } from '@/features/posts/notion-components/file';
import { GoogleDrive } from '@/features/posts/notion-components/google-drive';
import { LazyImage } from '@/features/posts/notion-components/lazy-image';
import { PageAside } from '@/features/posts/notion-components/page-aside';
import { PageIcon } from '@/features/posts/notion-components/page-icon';
import { PageTitle } from '@/features/posts/notion-components/page-title';
import { SyncPointerBlock } from '@/features/posts/notion-components/sync-pointer-block';
import { Text } from '@/features/posts/notion-components/text';
import {
  cs,
  getBlockParentPage,
  getListNumber,
  ...
  uuidToId,
} from '@/features/posts/notion-components/utils';
import { Decoration } from '@/interfaces/notion';
import type {
  AudioBlock,
  Block as BlockType,
  CodeBlock,
    ...
    case 'page':
      if (level === 0) {
        ...
        if (fullPage) {
          ...
          const hasAside = ((hasToc || pageAside) && !page_full_width) as boolean | '' | undefined;
                ...
                <div className="notion-page-scroller">
                  {hasPageCover &&
                    (pageCover ? (
                      ...
                      <div className="notion-page-cover-wrapper">
                        <LazyImage
                          src={mapImageUrl(page_cover as string, block)}
                  ...
                  >
                    ...
                    <h1 className="notion-title">
                      {pageTitle ?? (
                        <Text
                          value={properties?.title as Decoration[]}
                          block={block}
                        />
                      )}
                    </h1>
